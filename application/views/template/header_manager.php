        ...
        <div class="col-md-3 left_col menu_fixed">
          <div class="left_col scroll-view">
            <div class="navbar nav_title" style="border: 0;">
              <a href="<?php echo base_url()?>manager" class="site_title"><i class="fa fa-cogs"></i> <span>Pit Stop</span></a>
            </div>
            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                  <li><a href="<?php echo base_url()?>manager"><i class="fa fa-home"></i>Home</a>
                  <li><a><i class="fa fa-bicycle"></i> Spareparts <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="<?php echo base_url();?>manager/daftar">Daftar Spareparts</a></li>
                    </ul>
                  </li>
            
                  <li><a><i class="fa fa-edit"></i> Laporan Penjualan<span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="<?php echo base_url();?>manager/transaksi">Daftar Transaksi</a></li>
                      <li><a href="<?php echo base_url();?>manager/harian">Laporan Harian</a></li>
                      <li><a href="<?php echo base_url();?>manager/bulanan">Laporan Bulanan</a></li>
                      <li><a href="<?php echo base_url();?>manager/tahunan">Laporan Tahunan</a></li>
                    </ul>
                  </li>

                  <li><a><i class="fa fa-edit"></i> Laporan Pembelian<span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="<?php echo base_url();?>manager/btransaksi">Daftar Transaksi</a></li>
                      <li><a href="<?php echo base_url();?>manager/bharian">Laporan Harian</a></li>
                      <li><a href="<?php echo base_url();?>manager/bbulanan">Laporan Bulanan</a></li>
                      <li><a href="<?php echo base_url();?>manager/btahunan">Laporan Tahunan</a></li>
                    </ul>
                  </li>

                  <li><a><i class="fa fa-child"></i> Karyawan<span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="<?php echo base_url();?>manager/karyawan">Daftar Karyawan</a></li>
                    </ul>
                  </li>
                </ul>
              </div>
