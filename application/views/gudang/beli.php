<!-- page content -->
        <div class="right_col" role="main">
          <div class="">
            ...
            <form  method="POST" action="<?php echo base_url()?>gudang/input" class="form-horizontal" name="form">
            <div class="row">
                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <p class="text-muted font-13 m-b-30">
                      Daftar sparepart motor, ceklis <input type="checkbox" checked=""> apabila sparepart dibeli
                    </p>
                      ...
                      <tbody>
                        <tr>
                          ...
                          <?php foreach ($sport as $i): ?>
                            ...
                            <td>Rp.<input type="text" name="b<?php echo $i->id_sparepart?>" id="a<?php echo $no?>"  value="<?php echo $i->harga_supplier ?>" onkeydown="return(f_validchar('0123456789',event))"
                            onkeyup="
                            document.getElementById('total<?php echo $no?>').value= document.getElementById(('a<?php echo $no?>')).value *  document.getElementById('b<?php echo $no?>').value;
                            total();
                            kembali();" disabled data-toggle='tooltip' title='Harga dari Supplier'></td>
                            ...
                            document.getElementById('total<?php echo $no?>').value= document.getElementById(('a<?php echo $no?>')).value *  document.getElementById('b<?php echo $no?>').value;
                            total();
                            kembali();" disabled data-toggle='tooltip' title='Jumlah Barang Dibeli'></td>
                ...
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                  <table>
                    ...
                    <tr>
                      ...
                      <td><b>:</b> Rp.<input type="text" name="kembalian" value="0" id="kembalian" readonly></td>
                    </tr>
                  </table>
                </div> 
                 
                <input type="hidden" name="data" id="w"><br>
                <input onclick="klik()" class="btn btn-primary" type="submit" value="Save" disabled id="button" data-toggle='tooltip' title='Save Transaksi'></input><a href="<?php echo base_url();?>gudang/beli" class="btn btn-danger" data-toggle='tooltip' title='Hapus Transaksi'>Clear</a>
              </div>
            </div>
            </form>
