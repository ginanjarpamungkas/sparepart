...
<body>
	...
	<section>
		<div class="details clearfix">
			<div class="client left">
				<p>Kwitansi No : KT<?php echo $beli->id_beli;?></p>
			</div>
			<div class="data right">
				<div class="title">Struk Pembayaran</div>
				<div class="date">
					Tanggal Transaksi: <?php echo $beli->tgl_beli;?>
				</div>
			</div>
		</div>
		<div class="container">
				...
				<table>
					...
					<?php $no=1; ?>
						...
						<tr>
							...
							<td class="qty"><?php echo $r->jumlah_beli;?> pcs</td>
							<td class="unit">Rp. <?php echo number_format($r->harga_supplier,0,".",".");?></td>
							<td class="total">Rp. <?php echo number_format($r->total_harga,0,".",".");?></td>
						</tr>
						<?php $no++?>
                      <?php endforeach ?>
					</tbody>
	...
	<footer>
		<div class="container">
			<div class="end"><p align="center"> Terimakasih atas kerjasama anda <br> ==== LAYANAN KONSUMEN PIT STOP SPAREPARTS ==== <br> SMS: 081227535208   CALL: 15045 <br> E-mail: Ginanjar69919082@gmail.com</p></div>
		</div>
	</footer>
