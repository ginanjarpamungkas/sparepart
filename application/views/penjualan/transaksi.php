                       ...
                       <table id="datatable" class="table table-striped table-bordered">
                        ...
                        <?php foreach ($jual as $r): ?>
                          <tr>
                            ...
                            <td align="center"><a href="<?php echo base_url()?>penjualan/detail/<?php echo $r->id_jual?>" data-toggle="tooltip" title="View Struk"><i class="glyphicon glyphicon-eye-open"></i></a></td>
                          </tr><?php endforeach ?>
                        </tbody>
                      </table>
