            ...
            <div class="page-title">
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                  <form action="<?php echo base_url()?>penjualan/action_harian" method="POST">
                    ...
                    <table id="datatable" class="table table-striped table-bordered">
                      <thead>
                        <tr>
                          ...
                          <th>Jumlah Sparepart Terjual</th>
                        ...
                        <?php foreach ($jual as $r): ?>
                          <tr>
                            <td><?php echo $r->tgljual;?></td>
                            <td><?php echo $r->nama_sparepart;?></td>
                            <td><?php echo $r->jumlah_jual;?> pcs</td>
                            <td>Rp. <?php echo number_format($r->harga_satuan,0,".",".");?></td>
                            <td>Rp. <?php echo number_format($r->harga_total,0,".",".");?></td>
                          </tr><?php endforeach ?>
